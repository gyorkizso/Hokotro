...
/**
 * A Model.GravelState a zúzottkő szóró fej által létrehozott átmeneti sávállapotot reprezentálja.
 *
...
public class GravelState extends LaneState {
     ...
     * a havas küszöböt, akkor egy Model.SnowyState is hozzáadódik a sávhoz.
     *
