...
/**
 * A Model.ClearState a tiszta, hómentes vagy alacsony havú útállapotot reprezentálja.
 *
 * Felelőssége, hogy havazás hatására ellenőrizze,
 * a sáv elérte-e a havas állapot küszöbét.
 * Ha igen, a sáv Model.SnowyState állapotba vált.
 */
public class ClearState extends LaneState {
     ...
     * a Model.ClearState helyére Model.SnowyState kerül.
     *
