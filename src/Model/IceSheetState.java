...
/**
 * Az Model.IceSheetState a jégpáncélos útállapotot reprezentálja.
 *
...
public class IceSheetState extends LaneState {
     ...
     * meghívni, de a jelenlegi repóban a Model.Vehicle osztályban nincs
    ...
    public void onVehicleEnter(Vehicle vehicle) {
        ...
        // Model.Snowplow esetén nincs külön következmény.
