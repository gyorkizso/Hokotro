...
/**
 * A Model.SnowyState a havas útállapotot modellezi.
 *
...
public class SnowyState extends LaneState {
     ...
     * Ha a jég eléri a küszöböt, a sáv Model.IceSheetState állapotba vált.
     *
     ...
     * a Model.SnowyState helyére Model.SnowdriftState kerül.
     *
     ...
     * a Model.SnowyState helyére Model.ClearState kerül.
     */
    @Override
